...
#define STRING_CONFIG_H_AUTHOR "(PicVert - Alpha, Anet A8 Plus)" // Who made the changes.
...
#define PID_K1 0.92      // Smoothing factor within any PID loop
...
#define PROBING_MARGIN 10 // same value as NOZZLE_TO_PROBE_OFFSET X OR Y
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define  PROBING_MARGIN_BACK   150
...
#define HOMING_FEEDRATE_MM_M { 6000, 600, 400 }
...
*
* Mesure la largeur du filament en temps réel et ajuste
* débit pour compenser d'éventuelles irrégularités.
*
* Permet également au diamètre de filament mesuré de définir le
* taux d'extrusion, de sorte que le trancheur n'a qu'à spécifier le
* le volume.
*
* Une seule extrudeuse est prise en charge pour le moment.
*
...
//#define  DEFAULT_NOMINAL_FILAMENT_DIA  3.00    // (mm) Diamètre du filament généralement utilisé (3.0 ou 1.75mm), également utilisé dans le slicer. Utilisé pour valider la lecture du capteur.

# if ENABLED(FILAMENT_WIDTH_SENSOR)
  #define  FILAMENT_SENSOR_EXTRUDER_NUM  0     // Index de l'extrudeur qui a le capteur de filament (0,1,2,3)
  #define  MEASUREMENT_DELAY_CM         14     // (cm) La distance entre le capteur de filament et la chambre de fusion

  #define  MEASURED_UPPER_LIMIT          3.30  // (mm) Limite supérieure utilisée pour valider la lecture du capteur
  #define  MEASURED_LOWER_LIMIT          1.90  // (mm) Limite inférieure utilisée pour valider la lecture du capteur
  #define  MAX_MEASUREMENT_DELAY        20     // (octets) Taille du tampon pour les mesures stockées (1 octet par cm). Doit être supérieur à MEASUREMENT_DELAY_CM.

  #define  DEFAULT_MEASURED_FILAMENT_DIA DEFAULT_NOMINAL_FILAMENT_DIA // Définir initialement mesuré sur nominal

  // Affiche la largeur du filament sur la ligne d'état LCD. Les messages d'état expireront après 5 secondes.
